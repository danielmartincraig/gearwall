...
* [`src/gearwall/`](src/gearwall/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/gearwall/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `gearwall` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/gearwall/config.cljs) defaults to `true` in
...
```clj
(ns gearwall.example
  (:require [gearwall.config :as config])
